---
name: prep-discovery-freeform
description: Organize a complete freeform Discovery request into a reviewed file without starting the workflow.
...
run Discovery in as many independent model windows as useful with the `discovery` skill:
