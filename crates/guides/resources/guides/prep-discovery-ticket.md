...
Read the saved file back. In chat, provide its absolute path. Tell the user to paste the original ticket verbatim into the placeholder and review/edit the file, then run Discovery in as many independent model windows as useful with the `discovery` skill:
